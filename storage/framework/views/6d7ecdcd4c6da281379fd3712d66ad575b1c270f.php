        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('hotels.save')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <!-- Email input -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\vaction-rental\resources\views/admins/createhotels.blade.php ENDPATH**/ ?>