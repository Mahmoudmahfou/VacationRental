<?php $__env->startSection('content'); ?>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo e(asset('assets/images/image_2.jpg')); ?>');" data-stellar-background-ratio="0.5">
            ...
            <div class="row">
                ...
                <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
                    <div class="d-block services-wrap text-center">
                        <div class="img" style="background-image: url(<?php echo e(asset('assets/images/'.$hotel->image.'')); ?>);"></div>
                        <div class="media-body py-4 px-3">
                            <h3 class="heading"><?php echo e($hotel->name); ?></h3>
                            <p><?php echo e($hotel->description); ?></p>
                            <p>Location: <?php echo e($hotel->location); ?>.</p>
                            <p><a href="<?php echo e(route('hotels.rooms',$hotel->id)); ?>" class="btn btn-primary">View rooms</a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6">
                    <div class="room-wrap d-md-flex">
                        <a href="#" class="img" style="background-image: url(<?php echo e(asset('assets/images/'.$room->image.'')); ?>);"></a>
                        <div class="half left-arrow d-flex align-items-center">
                            <div class="text p-4 p-xl-5 text-center">
                                ...
                                <ul class="list-accomodation">
                                    ...
                                    <li><span>Price:</span> <?php echo e($room->price); ?> $/night</li>
                                </ul>
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-6 wrap-about">
                    <div class="img img-2 mb-4" style="background-image: url(<?php echo e(asset('assets/images/image_2.jpg')); ?>);">
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\vaction-rental\resources\views/home.blade.php ENDPATH**/ ?>