...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-lg navbar-light ftco_navbar bg-light ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">Vacation<span>Rental</span></a>
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="<?php echo e(route('services')); ?>" class="nav-link">Services</a></li>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(route('users.bookings')); ?>">
                                        My Bookings
                                    </a>
...
<?php /**PATH C:\laravel\vaction-rental\resources\views/layouts/app.blade.php ENDPATH**/ ?>