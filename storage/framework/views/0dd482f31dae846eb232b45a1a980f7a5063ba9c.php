        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
                ...
                <div class="col-md-7 ftco-animate">
                    ...
                    <h1 class="mb-4"><?php echo e($getRoom->name); ?></h1>
    ...
    <section class="ftco-section ftco-book ftco-no-pt ftco-no-pb">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-lg-4">
                    <form action="<?php echo e(route('hotels.rooms.booking', $getRoom->id)); ?>" method="POST" class="appointment-form"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <h4 class="alert alert-danger text-center mt-2">Login To Book a Room</h4>
                                    <?php endif; ?>
                                </div>
                                ...
                                <?php if(session('error')): ?>
                                    <h4 class="alert alert-danger text-center mt-2"><?php echo e(session('error')); ?></h4>
                                <?php endif; ?>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\vaction-rental\resources\views/hotels/roomdetails.blade.php ENDPATH**/ ?>